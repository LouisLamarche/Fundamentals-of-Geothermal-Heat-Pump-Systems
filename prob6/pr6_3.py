...
#
# summation of the first  12 pulses
#
# 1er
#
Fof = alhr*tf/rb**2
...
Tbc = To- DeltaTc
print (('\t Borehole Final  temperature    c)  ' + str(Tbc) + ' C'))
Tf = Tbc - qph*Rpb               # valeur de Rb vient de la question 1
print (('\t Fluid Final  temperature    c) est    ' + str(Tf) + ' C'))
#