...
fr = 0.04
rr = 0.06
miira1,eca = calcul_miir(rr,fr,dpaa,paiementia,econ_caria,vra,mia,maintenancea)
profits = np.maximum(eca,0)
pertes = np.maximum(-eca,0)

miira2 = mirr(dpaa,profits-pertes,rr,fr)
print(tria,miira1,miira2)
miirb1,ecb = calcul_miir(rr,fr,dpab,paiementib,econ_carib,vrb,mib,maintenanceb)
profits = np.maximum(ecb,0)
pertes = np.maximum(-ecb,0)
miirb2 = mirr(dpab,profits-pertes,rr,fr)
